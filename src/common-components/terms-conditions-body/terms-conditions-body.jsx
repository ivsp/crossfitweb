function TermsConditionsBody() {
  return (
    ...
    >
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to WOD TARGET.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to WOD TARGET, accessible from{" "}
            <a
              href="http://www.wodtarget.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              http://www.wodtarget.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: crossfitneoland@gmail.com</li>
      </ul>
    </section>
  );
}
